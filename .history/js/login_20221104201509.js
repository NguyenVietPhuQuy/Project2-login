...
function checkLogin() {
    ...
    for (let item of account) {
        if (accountCheck === item.nameMember && passwordCheck === item.passwordMember) { window.location.href = "https://project2-cyber-soft-qtk9.vercel.app/"; alert('successful login');}
        else {
